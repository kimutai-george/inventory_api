...
from user_control.views import add_user_activities

class InventoryGroup(models.Model):
    created_by = models.ForeignKey(CustomUser,related_name="inventory_groups",null=True,on_delete=models.SET_NULL)
...
class Inventory(models.Model):
    created_by = models.ForeignKey(CustomUser, related_name="inventory_items",null=True, on_delete=models.SET_NULL)
...
class Shop(models.Model):
    created_by = models.ForeignKey(CustomUser, related_name="shops",null=True, on_delete=models.SET_NULL)
...
class InvoiceItem(models.Model):
    invoice = models.ForeignKey(Invoice, related_name="invoice_items",null=True, on_delete=models.CASCADE)
    ...
    def save(self,*args,**kwargs):
        if self.item.remaining < self.quantity:
            raise Exception(f"item with code - {self.item.code} does not enough quantity")
